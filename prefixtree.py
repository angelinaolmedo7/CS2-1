...
class PrefixTree:
    ...
    def contains(self, string):
        ...
        return string in self.complete(string)
    ...
    def _find_node(self, string):
        ...
        for character in string:
            if working_node.has_child(character):
                ...
                return working_node, depth
        return working_node, depth
        # could combine this with insert to make code more dry but... don't wanna
    ...
    def complete(self, prefix):
        ...
        working_node, depth = self._find_node(prefix)
        if depth < len(prefix):
            return []
        return self.recursive_children(working_node, prefix[:-1])
        
    def recursive_children(self, node=None, previous=""):
        """Recursively navigate children, adding terminal nodes to the return list."""
        ...
        for child in node.children:
            return_list.extend(self.recursive_children(child, previous+node.character))
